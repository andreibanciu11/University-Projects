...
public class Service {
    ...
    public double addNota(Nota nota, String feedback){
        ...
        if(predare != tema.getDeadline()){
            System.out.println("PREDARE " + predare);
            System.out.println("AAA" + tema.getDeadline());
    ...
    private int calculeazaSPredare(LocalDate predare) {
        ...
        System.out.println("calculeaza predare, predare: " + predare);
        System.out.println("calculeaza predare, start date: " + startDate);
