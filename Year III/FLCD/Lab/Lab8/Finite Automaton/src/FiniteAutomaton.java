...
public class FiniteAutomaton {
    ...
    public Map<KeyValuePair<String, String>, Set<String>> transitions;
        ...
        try {
            ...
            while(reader.hasNextLine()){
                ...
                if(states.contains(transitionElements[0]) && states.contains(transitionElements[2]) && alphabet.contains(transitionElements[1])) {
                    ...
                    KeyValuePair<String, String> transitionStates = new KeyValuePair<>(transitionElements[0], transitionElements[1]);
    ...
    public boolean checkSequence(String sequence){
        ...
        for (int i = 0; i < sequence.length(); ++i) {
            ...
            KeyValuePair<String, String> key = new KeyValuePair<>(currentState, inputSymbol);
            if (transitions.containsKey(key)) {
                Set<String> possibleNextStates = transitions.get(key);
